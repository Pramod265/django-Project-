...
$(document) .ready(function(){
  ...
  $('#add-student').click(function (e) {
      ...
      $("#id_first_name,#id_last_name,#id_email,#id_middle_name,#id_mobile,#id_dob,#id_blood_group,#id_religion,#id_caste,#id_nationality,#id_place_of_birth,#id_address,#id_address2,#id_mother_name").each(function(){
