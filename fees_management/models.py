...
class DpyInstituteClassFee(models.Model):
	fee_type_id = models.ForeignKey(DpyFeeType, on_delete=models.PROTECT)
	institute_class_id = models.ForeignKey(DpyInstituteClass, on_delete=models.PROTECT)
	amount = models.PositiveSmallIntegerField() 
	cycle = models.PositiveSmallIntegerField()
	display_name = models.CharField(max_length=250)
	bifercations = models.TextField()
	status = models.PositiveSmallIntegerField(1)
	added_by = models.IntegerField(default=0)
	added_on = models.DateTimeField(auto_now_add=True)
	updated_by = models.IntegerField(default=0)
	updated_on = models.IntegerField(default=0)
...
class DpyUserFeeIgnore(models.Model):
	institute_class_fee_id = models.ForeignKey(DpyInstituteClassFee,on_delete=models.PROTECT)
	user_id = models.ForeignKey(DpyUsers,on_delete=models.PROTECT)
...
class DpyFeeTransaction(models.Model):
	user_id = models.ForeignKey(DpyUsers,on_delete=models.PROTECT)
	institute_class_fee_id = models.ForeignKey(DpyInstituteClassFee,on_delete=models.PROTECT)
	receipt_id = models.ForeignKey(DpyPaymentReceipt,on_delete=models.PROTECT)
