...
class DpyClassBatch(models.Model):
    ic = models.ForeignKey(DpyInstituteClass, related_name='batch', on_delete=models.PROTECT)
    name = models.CharField(max_length=150)
    status = models.PositiveSmallIntegerField(default=1)
    created_on = models.DateTimeField(auto_now_add=True)
    created_by = models.IntegerField(default=0)
...
class DpyInstituteUserClass(models.Model):
    ...
    batch = models.ForeignKey(DpyClassBatch, related_name='user_batch',on_delete=models.PROTECT, null=True)
    user_type = models.PositiveSmallIntegerField(default=1)#1:Student,2:Teacher
...
class DpyInstituteTimeTable(models.Model):
    ...
    user = models.ForeignKey(DpyUsers,on_delete=models.PROTECT)
    batch = models.ForeignKey(DpyClassBatch, on_delete=models.PROTECT, null=True)
...
class DpyUserDayPresenties(models.Model):
    institute = models.ForeignKey(DpyInstitute, on_delete=models.PROTECT)
    user = models.ForeignKey(DpyUsers, on_delete=models.PROTECT)
    marked_by = models.IntegerField()
    date = models.DateField()
