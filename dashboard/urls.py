...
urlpatterns = [
    ...
    url(r'^get_student/(?P<id>\d+)/$',views.getStudent,name='get_student'),
    ...
    #--------------------------------------------actual API FOR MODEL VIEW SET
    path('students/', views.Students.as_view({'post':'add_student','get':'get_students'}), name='students'),

    path('Add_Additional_Field/', views.AddAdditionalField.as_view(), name='AddAdditionalField'),
